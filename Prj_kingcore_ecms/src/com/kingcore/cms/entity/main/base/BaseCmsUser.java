...
public abstract class BaseCmsUser  implements Serializable {
	...
	public BaseCmsUser (
		...
		com.kingcore.cms.entity.main.CmsGroup group,
	...
	// many to one
	private com.kingcore.cms.entity.main.CmsGroup group;

	// collections
	private java.util.Set<com.kingcore.cms.entity.main.CmsUserExt> userExtSet;
	private java.util.Set<com.kingcore.cms.entity.main.CmsUserSite> userSites;
	private java.util.Set<com.kingcore.cms.entity.main.CmsRole> roles;
	private java.util.Set<com.kingcore.cms.entity.main.Channel> channels;
	private java.util.Set<com.kingcore.cms.entity.main.Content> collectContents;
	
	private java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> sendMessages;
	private java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> receivMessages;
	private java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages;
	private java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages;
	 ...
	 */
	public com.kingcore.cms.entity.main.CmsGroup getGroup () {
		return group;
	}
	 ...
	 */
	public void setGroup (com.kingcore.cms.entity.main.CmsGroup group) {
		this.group = group;
	}
	 ...
	 */
	public java.util.Set<com.kingcore.cms.entity.main.CmsUserExt> getUserExtSet () {
		return userExtSet;
	}
	 ...
	 */
	public void setUserExtSet (java.util.Set<com.kingcore.cms.entity.main.CmsUserExt> userExtSet) {
	 ...
	 */
	public java.util.Set<com.kingcore.cms.entity.main.CmsUserSite> getUserSites () {
		return userSites;
	}
	 ...
	 */
	public void setUserSites (java.util.Set<com.kingcore.cms.entity.main.CmsUserSite> userSites) {
	 ...
	 */
	public java.util.Set<com.kingcore.cms.entity.main.CmsRole> getRoles () {
		return roles;
	}
	 ...
	 */
	public void setRoles (java.util.Set<com.kingcore.cms.entity.main.CmsRole> roles) {
		this.roles = roles;
	}
	...
	public java.util.Set<com.kingcore.cms.entity.main.Content> getCollectContents() {
		return collectContents;
	}

	public void setCollectContents(
			java.util.Set<com.kingcore.cms.entity.main.Content> collectContents) {
		this.collectContents = collectContents;
	}
	
	public java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> getSendMessages() {
		return sendMessages;
	}

	public void setSendMessages(
			java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> sendMessages) {
		this.sendMessages = sendMessages;
	}

	public java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> getReceivMessages() {
		return receivMessages;
	}

	public void setReceivMessages(
			java.util.Set<com.kingcore.cms.entity.assist.CmsMessage> receivMessages) {
		this.receivMessages = receivMessages;
	}

	public java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> getSendReceiverMessages() {
		return sendReceiverMessages;
	}

	public void setSendReceiverMessages(
			java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> sendReceiverMessages) {
		this.sendReceiverMessages = sendReceiverMessages;
	}

	public java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> getReceivReceiverMessages() {
		return receivReceiverMessages;
	}

	public void setReceivReceiverMessages(
			java.util.Set<com.kingcore.cms.entity.assist.CmsReceiverMessage> receivReceiverMessages) {
		this.receivReceiverMessages = receivReceiverMessages;
	}

	public boolean equals (Object obj) {
		if (null == obj) return false;
		if (!(obj instanceof com.kingcore.cms.entity.main.CmsUser)) return false;
		else {
			com.kingcore.cms.entity.main.CmsUser cmsUser = (com.kingcore.cms.entity.main.CmsUser) obj;
