...
var YWebClipperConfiguration = {
    logEnabled: !1,
    clipperBaseURL: "http://m.zhongyi360.cn/clipper",
    ...
    e.common = {
        ...
        findPos: function(e) {
            ...
            if (!document.documentElement.getBoundingClientRect()) while (e) t.x += e.offsetLeft,
            t.y += e.offsetTop,
            e = e.offsetParent;
            else t.x = e.getBoundingClientRect().left + this.scroll().left,
            t.y = e.getBoundingClientRect().top + this.scroll().top;
            return t
        },
        ...
        css: function() {
            var e = function(e, t) {
                ...
                } else n = null; (n == "auto" || n.indexOf("%") !== -1) && ("width" === t.toLowerCase() || "height" === t.toLowerCase()) && e.style.display != "none" && n.indexOf("%") !== -1 && (n = e["offset" + t.charAt(0).toUpperCase() + t.substring(1).toLowerCase()] + "px");
                if (t == "opacity") try {
    ...
    e.prototype = {
        ...
        getMainArticle: function() {
            var e = null,
            t = ""; ! location || (t = location.hostname);
    ...
    var t = function(t) {
        this.elem = t,
        this.common = e.common,
        this.offset = this.common.findPos(t),
        this._texts = this._getAllTexts(t, 6),
    ...
    t.prototype = {
            ...
            if (n > 0) {
                ...
                while (i) {
                    if (i.nodeType == 3 && this._checkLength(i)) {
                        var s = i.parentNode || {},
                        o = s.parentNode || {}; ! this._checkMinorContent(s) && !this._checkMinorContent(o) && e.common.trim(i.nodeValue) && r.push(i)
        ...
        calcContentWeight: function() {
            var e = 1;
            for (var t = this.elem; t; t = t.parentNode) t.id && (this.MAJOR_REGEXP.test(t.id) && (e += .4), this.MINOR_REGEXP.test(t.id) && (e -= .8)),
            t.className && (this.MAJOR_REGEXP.test(t.className) && (e += .4), this.MINOR_REGEXP.test(t.className) && (e -= .8));
            return e
        },
        calcWeight: function() {
        ...
        _checkTitle: function() {
            ...
            if (n.length > 2) {
                ...
                for (var s = 0,
                o = e.common.findPos(this.elem), u = i * .05, a = 0; n[a]; a++) {
...
function() {
    ...
    t = null,
    n = window.document;
    typeof YNote != "undefined" && (t = YNote),
    YNote = {},
    YNote.Common = {
        browser: function() {
            return {
        ...
        enableDrag: function(e) {
            var t = window;
            typeof e == "string" && (e = YNote.Common.el(e)),
            e.nodeType && e.nodeType == 1 && e.tagName.toLowercase() == "div" && (e.style.position = "absolute", YNote.Common.addEvent(e, "mousedown",
            function(e) {
            ...
            }), typeof t.YNoteDragObject == "undefined" && (YNote.Common.addEvent(t.document, "mouseup",
            function(e) {
                t.YNoteDragObject != null && (t.YNoteDragObject = null)
            }), YNote.Common.addEvent(t.document, "mousemove",
            function(e) {
                if (typeof t.YNoteDragObject == "undefined" || t.YNoteDragObject == null) return;
                var n = YNote.Common.wrapperEvent(e);
                t.YNoteDragObject.element.style.left = n.x - t.YNoteDragObject.startX + "px",
                t.YNoteDragObject.element.style.top = n.y - t.YNoteDragObject.startY + "px"
            })))
        },
        ...
        log: function(e) {
            ...
            typeof console == "undefined" && (console = function() {
                ...
                return e.style.cssText = "width:100%;height:500px;border:1pt solid black;position:absolute;left:0px;top:800px",
                e.innerHTML = '<textarea style="width:100%;height:450px" id="console_log"></textarea>',
        ...
        HTMLEncode: function(e) {
            ...
            if (i >= 7) for (var s = 0; s < n; s++) t += e.charCodeAt(s) + " ";
        ...
        unicodeEncode: function(e) {
            var t = "";
            if (typeof e == "string") for (var n = 0; n < e.length; n++) {
    ...
    YNote.Common.extend(YNote.StyleUtil.prototype, {
        styleForNode: function(e, t) {
            ...
            if (e && e.nodeType && e.nodeType == 1) {
                ...
                for (var a = 0; a < i.length; a++) if (YNote.Common.browser.isIE) {
                    var f = i[a];
                ...
                return this.cssArray = o,
                this.getStyleString(o)
            }
            return ""
        },
    ...
    YNote.Common.extend(YNote.Clipper.prototype, {
        ...
        rangeIntersectsNode: function(e) {
            ...
            if (this.range) {
                if (e.nodeType == 1) {
                    ...
                    return r.moveToElementText(e),
                    r.compareEndPoints("StartToEnd", this.range) == -1 && r.compareEndPoints("EndToStart", this.range) == 1
                }
                return ! 0
            }
            return ! 1
        ...
        isNodeVisible: function(e) {
            if (e.nodeType) {
                ...
                if (e.nodeType == 3) if (e.nodeValue || e.nodeValue.length == 0) return ! 1;
        ...
        replaceURL: function(e) {
            ...
            return i = i.substr(0, i.lastIndexOf("/")) + "/",
            rbase = r + "//" + n,
            (t = e.match(/^(https?):/i)) != null ? e: e.indexOf("/") == 0 ? rbase + e: i + e
        },
        getNodeText: function(e, t) {
            ...
            if (e.nodeType == 3) this.range ? this.range.startContainer == e && this.range.startContainer == this.range.endContainer ? n += e.nodeValue.substring(this.range.startOffset, this.range.endOffset) : this.range.startContainer == e ? n += e.nodeValue.substring(this.range.startOffset) : this.range.endContainer == e ? n += e.nodeValue.substring(0, this.range.endOffset) : this.range.commonAncestorContainer != e && (n += e.nodeValue) : n += e.nodeValue;
                ...
                if (!this.range || this.range.commonAncestorContainer != e || !!this.isListNode(e)) if (e.hasChildNodes() || !this.isCloseTag(e)) n += "</" + o + ">",
                e === i.doc.mainContent && i.doc.contentType !== "3" && (n += i.doc.mainContentTag)
            }
            return n
        },
        getSelectedContent: function() {
            if (this.hasSelection()) {
                if (YNote.Common.browser.isIE) return YNote.Common.log(this.selection.htmlText),
                this.selection.htmlText ? (this.content = this.selection.htmlText, this.selection.htmlText) : (this.content = this.getNodeText(this.getRangeContainer(this.range)), this.content);
                var e = this.selector.getSelectionRange(),
                t = "";
                return t = this.getNodeText(e.commonAncestorContainer),
                t == "" && YNote.Common.log("Get Selected ERROR!"),
                t
            }
        },
        getRangeContainer: function(e) {
            ...
            while (n.top > r.top || n.bottom < r.bottom) t = t.parentNode,
            n = t.getBoundingClientRect();
            return t
        },
        initFrame: function() {
        ...
        init: function() {
            ...
            i.id = t,
            i.name = t,
            YNote.Common.browser.isIE && (document.getElementsByTagName("html")[0].cssText = "background-image:url(about:blank);background-attachment:fixed", document.getElementsByTagName("body")[0].cssText = "background-image:url(about:blank);background-attachment:fixed"),
            i.style.cssText = e.clipperStyle,
            i.style.zIndex = 999999,
            this.wrapper = i;
            var s = YNote.Common.mkel("div", i);
            s.style.cssText = "width:400px;padding:5px;background-color:rgba(92,184,229,.5)!important;background:#5cb8e5;border-radius:5px;box-shadow:0 0 2px #5cb8e5;    -khtml-border-radius:5px;-webkit-border-radius:5px;-webkit-box-shadow:0 0 2px #5cb8e5;-moz-border-radius:5px;-moz-box-shadow:0 0 2px #5cb8e5;",
            s.id = "ydNoteWebClipper-New",
            s.className = "ydnwc-dialog";
        ...
        clearFlash: function() {
            ...
            for (var i = 0,
            s = t.length; i < s; i++)(e && t[i] && t[i]["classid"] == "clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" || t[i] && t[i]["type"] == "application/x-shockwave-flash" || t[i] && t[i].parentNode.innerHTML.indexOf("application/x-shockwave-flash") > 0) && t[i].parentNode && t[i].parentNode.removeChild(t[i])
        },
        reset: function() {
            ...
            this.view.innerHTML.length > 10 && this.deleteFrame(),
            this.initFrame()
        },
        ...
        fillForm: function() {
            ...
            n.doc.mainContentTag && (this.content += "$" + n.doc.mainContentTag),
            this.content = e == "true" ? YNote.Common.HTMLEncode(this.content) : YNote.Common.unicodeEncode(this.content),
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "path").value = this.path,
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "content").value = this.content,
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "source").value = YNote.Common.HTMLEncode(this.source),
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "title").value = YNote.Common.HTMLEncode(this.title),
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "len").value = this.content.length,
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "type").value = r.split(" ")[n.doc.contentType - 1],
            t.getElementById(n.clipperDomPrefix + "ContentForm" + "sign").value = this.getNavigatorSign()
        }
    }),
    ...
    YNote.Common.extend(YNote.Selection.prototype, {
        getSelection: function() {
            var e = window,
            t = e.document;
            return YNote.Common.browser.isIE ? this.selection = document.selection: this.selection = e.getSelection(),
            this.hasSelection() ? this.selectionParentWindow = e: this.getNestedRange(e),
            this.selection
        },
        hasSelection: function() {
            return YNote.Common.log("Enter hasSelection"),
            typeof this.selection.createRange == "function" ? this.selection.createRange().htmlText == "" ? !1 : !0 : this.selection.rangeCount == 0 ? !1 : !0
        },
            ...
            i = n.length; r < i; r++) {
                ...
                try {
                    ...
                    if (typeof u.createRange == "function" || typeof u.getRangeAt == "function") {
                        ...
                        this.selection = u,
                        this.selectionparentWindow = s;
                        if ( !! this.hasSelection()) return this.selection = a,
                        !1;
                        var f = 0,
                        e = s;
                        while (e !== window) {
        ...
        getSelectionRange: function() {
            ...
            if (YNote.Common.browser.isIE && this.range) {
                ...
                this.range.startContainer = t.el,
                this.range.startOffset = t.offset;
                var n = this.range.duplicate();
                n.collapse(!1),
                t = this.getContainerForIE(n),
                this.range.endContainer = t.el,
                this.range.endOffset = t.offset
            }
            return this.range
        },
        ...
        getContainerForIE: function(e) {
            ...
            while (s) {
                ...
                case 3:
                    ...
                    var o = r - nodeLength;
                    i == 1 ? n.moveStart("character", o) : n.moveEnd("character", -o),
                    r = o;
                    break;
                case 1:
                    nodeLength = s.innerText.length,
                    i == 1 ? n.moveStart("character", nodeLength) : n.moveEnd("character", -nodeLength),
                    r -= nodeLength
                }
        ...
        getSelectionHTMLText: function() {
            ...
            this.range ? YNote.Common.browser.isIE ? this.range.htmlText: "": !1
        }
    }),
    ...
    YNote.Common.extend(YNote.ClipperManager.prototype, {
        run: function() {
            ...
            if (!this.checkEnv()) return YNote.Common.log("check Env false"),
    ...
    YNote.App.prototype = {
        crossDomain: function() {
            ...
            e.browser = function() {
                ...
                n;
                return (n = t.match(/msie ([\d.]+)/)) ? e.msie = n[1] : (n = t.match(/firefox\/([\d.]+)/)) ? e.firefox = n[1] : (n = t.match(/chrome\/([\d.]+)/)) ? e.chrome = n[1] : (n = t.match(/opera.([\d.]+)/)) ? e.opera = n[1] : (n = t.match(/version\/([\d.]+).*safari/)) ? e.safari = n[1] : 0,
                e
            } (),
            e.each = function(t, n, r) {
                if (t === undefined || t === null) return;
                if (t.length === undefined || e.isFunction(t)) {
                    for (var i in t) if (t.hasOwnProperty(i) && n.call(r || t[i], i, t[i]) === !1) break
                } else for (var s = 0; s < t.length; s++) if (n.call(r || t, s, t[s]) === !1) break;
                return t
            },
            e.param = function(t) {
        ...
        createClipDiv: function() {
            if (this.mainElem) {
                ...
                u[0] = this.creatDiv("yShade0", s, t, l, 0),
                u[1] = this.creatDiv("yShade1", s, o - t - i, l, t + i),
        ...
        mainElem: function() {
            ...
            t = e.getMainArticle();
            return t && (YWebClipperConfiguration.doc.mainContent = t.elem, YWebClipperConfiguration.doc.contentType = "2"),
            t
        } (),
        run: function() {
        ...
        frameHandler: function(e) {
            ...
            case YNote.Clipper.UPLOADING_FILE:
                n.loadingView.style.display = "none",
                n.state = YNote.Clipper.DONE
            }
        }
    },
    YNote.Common.log("------------------");
    ...
    o = function() {
        ...
        document.readyState != "complete" && document.readyState != "loaded" && document.readyState != "interactive" || !document.body ? r = setTimeout(o, 300) : (window._ynote_app_load = !0, window.yApp = new YNote.App, yApp.run(), YWebClipperConfiguration.doc.contentType === "2" && yApp.createClipDiv(), yApp.crossDomain.receiveMessage(function(e) {
            if (e.data === "close") yApp.clipperManager.clipper.close(),
            yApp.removeClipDiv(),
            window.postMessage || (window.location = yApp.clipperManager.clipper.source);
                ...
                var n = 248,
                r = 530;
                e.data === "openid" ? (n = 248, r = 400) : e.data === "resize_fullpage" && (n = 285, r = 400),
                document.getElementById("ydNoteWebClipper_view").style.height = n + "px",
                YNote.Common.browser.isIE && (document.getElementById("ydNoteWebClipper_view").style.height = n + 10 + "px", document.getElementById("_YNoteContentFrame").style.height = n + 10 + "px"),
                document.getElementById("ydNoteWebClipper_view").style.width = r + "px",
                document.getElementById("ydNoteWebClipper-New").style.width = r + 2 + "px",
                document.getElementById("ydNoteWebClipper").style.width = r + 10 + "px"
            } else e.data === "remove" ? yApp.removeClipDiv() : e.data === "creat" && yApp.createClipDiv()
        },
        "http://note.youdao.com"), window.addEventListener ? window.addEventListener("resize", s) : window.attachEvent("onresize", s), s = function() {},
        clearTimeout(r))
    };
    r = setTimeout(o, 300),
    s = function() { ! window.yApp || (i && (clearTimeout(i), i = null), i = setTimeout(function() {
